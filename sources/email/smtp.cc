...
SmtpClient::ptr SmtpClient::Create(const std::string& host, uint32_t port,
                                   bool ssl) {
...
SmtpResult::ptr SmtpClient::send(EMail::ptr email, int64_t timeout_ms,
                                 bool debug) {
#define DO_CMD()              \
...
std::string SmtpClient::getDebugInfo() { return m_ss.str(); }
