...
int main() {
    ...
    // [AUTO-TRANSLATED:c857af94]
    //  All data types supported by ostream are supported, and custom type data
    //  can be printed through friend methods
    ...
    //[AUTO-TRANSLATED:1ca0e0f7]
    // Based on the RAII principle, there is no need to input endl here, and the
    // log will be printed when the function is popped from the stack
    ErrorL << "without endl!";
