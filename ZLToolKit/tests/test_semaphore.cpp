...
int main() {
    ...
    //[AUTO-TRANSLATED:59593bf0]
    // The program may force exit and core dump; when the program exits, the
    // number of produced tasks should be consistent with the number of consumed
    // tasks
