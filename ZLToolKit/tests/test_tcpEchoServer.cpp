...
class EchoSession : public Session {
   public:
    ...
    virtual void onError(const SockException &err) override {
        ...
        //[AUTO-TRANSLATED:6b958a7b]
        // Client disconnects or other reasons cause the object to be removed
        // from TCPServer management
        WarnL << err;
    }
...
int main() {
    ...
    // Load the certificate, the certificate contains the public key and private
    // key
